...
export async function LocationKlosterneuburgContent({ locale }: Props) {
  const t = await getTranslations("locationKlosterneuburg");
      ...
      <header className="bg-navy text-white py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs uppercase tracking-wider text-gray-500 mb-6 flex-wrap">
            ...
            <ChevronRight size={14} className="shrink-0" />
            <Link href="/locations/niederoesterreich" className="hover:text-gray-400 transition-colors">
              {tLoc("stateNames.niederoesterreich")}
            </Link>
            <ChevronRight size={14} className="shrink-0" />
